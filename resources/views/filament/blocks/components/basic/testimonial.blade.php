...
@if($isEditorPreview)
<div class="max-w-lg mx-auto rounded-xl shadow-lg overflow-hidden border-2 border-accent bg-primary-50 dark:bg-primary-900" data-laragrape-block="testimonial">
    <div class="p-6">
