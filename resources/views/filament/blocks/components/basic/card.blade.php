...
@if($isEditorPreview)
<div class="max-w-sm mx-auto rounded-xl shadow-lg overflow-hidden border-2 border-accent bg-primary-50 dark:bg-primary-900" data-laragrape-block="card">
    ...
    <div class="p-6">
        ...
        <span class="inline-block px-4 py-2 rounded-lg font-semibold bg-accent text-primary-900" data-gjs-type="text" data-gjs-name="card-button">Learn More</span>
    </div>
</div>
@else
