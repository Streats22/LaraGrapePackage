...
@if($isEditorPreview)
<div class="service-showcase-block py-16" style="background-color: var(--laralgrape-primary-50);" data-laragrape-block="service-showcase">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="service-card p-6 rounded-lg shadow-lg" style="background-color: var(--laralgrape-primary-50); border-left: 4px solid var(--laralgrape-accent);" data-gjs-type="default" data-gjs-droppable="false">
                ...
                <span class="w-full block text-center py-2 px-4 rounded font-semibold" style="background-color: var(--laralgrape-accent); color: var(--laralgrape-primary-900);" data-gjs-type="text" data-gjs-name="service-1-button">Learn More</span>
            </div>
            <div class="service-card p-6 rounded-lg shadow-lg" style="background-color: var(--laralgrape-primary-50); border-left: 4px solid var(--laralgrape-accent);" data-gjs-type="default" data-gjs-droppable="false">
                ...
                <span class="w-full block text-center py-2 px-4 rounded font-semibold" style="background-color: var(--laralgrape-accent); color: var(--laralgrape-primary-900);" data-gjs-type="text" data-gjs-name="service-2-button">Learn More</span>
            </div>
            <div class="service-card p-6 rounded-lg shadow-lg" style="background-color: var(--laralgrape-primary-50); border-left: 4px solid var(--laralgrape-accent);" data-gjs-type="default" data-gjs-droppable="false">
                ...
                <span class="w-full block text-center py-2 px-4 rounded font-semibold" style="background-color: var(--laralgrape-accent); color: var(--laralgrape-primary-900);" data-gjs-type="text" data-gjs-name="service-3-button">Learn More</span>
            </div>
        </div>
    </div>
</div>
