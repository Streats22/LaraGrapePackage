...
@if($isEditorPreview)
<div class="spacer-block" data-laragrape-block="spacer">
    <div class="h-16 bg-primary-100 border-2 border-dashed border-primary-300 flex items-center justify-center rounded-lg">
        <span class="text-primary-600 text-sm font-medium" data-gjs-type="text" data-gjs-name="spacer-label">Spacer (64px)</span>
    </div>
</div>
@else
